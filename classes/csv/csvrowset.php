...
class CSVRowSet implements ArrayAccess, Iterator, Countable
{
    /**
     * CSV Rows
     ...
     * @return CSVRowSet
     */
    public static function fromCSVFile( $fp, CSVOptions $options = null )
    {
